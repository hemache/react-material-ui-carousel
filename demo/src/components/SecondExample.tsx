...
const SecondExample = () => {
  ...
  return (
    <div style={{ marginTop: "50px", color: "#494949" }}>
      <Typography variant="h4">Example: hemache Projects (random)</Typography>
      <br />
...
const items: Item[] = [
  {
    ...
    color: "#64ACC8",
    href: "https://github.com/hemache/Lear-Music-Reader",
  },
  {
    name: "Hash Code 2019",
    description:
    ...
    color: "#7D85B1",
    href: "https://github.com/hemache/HashCode2019",
  },
  {
    name: "Terrio",
  ...
  },
  {
    ...
    color: "#C9A27E",
    href: "https://github.com/hemache/react-material-ui-carousel-mjs",
  },
];
